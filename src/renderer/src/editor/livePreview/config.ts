...
export interface LivePreviewConfig {
  ...
  linkEpoch: number
  /**
   * wave④/P18-F6: bumped on language flips so the decoration StateField
   * rebuilds; lang-sensitive widgets (fold/callout chips, table toolbar)
   * carry the lang/epoch in eq() and therefore re-render their DOM.
   */
  i18nEpoch?: number
