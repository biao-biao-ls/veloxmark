 ...
 *
 * NOTE: CodeMirror forbids view plugins from providing block widgets and
 * multi-line replace decorations — those must come from a StateField-provided
 * decoration set, which is why this is a StateField.
 *
